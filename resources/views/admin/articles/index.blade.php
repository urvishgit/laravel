...
@include('admin.includes.content_header', ['title' => 'News articles', 'route' => 'admin.articles.create', 'search' => true])
    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="w-100" id="data">
          @include('admin.articles.data', ['articles' => $articles])
        </div>
      </div>
    </div>
  </div>
</div>
@include('admin.includes.admin_delete_model', ['title' => 'Article'])
@endsection