...
@include('admin.includes.content_header', ['title' => 'Team members', 'route' => 'admin.team.create', 'search' => true])
      ...
      <div class="card">
        <div class="w-100 card-header">
          ...
          <div class="col-11 pl-0 float-left data-list">
            <div class="col-2 float-left pl-0 data-ordering" data-order="" data-order-by="title">Title</div>
            <div class="col-2 float-left data-ordering" data-order="" data-order-by="category.title">Category</div>
            <div class="col-3 float-left data-ordering" data-order="" data-order-by="category.email">Contact</div>
            <div class="col-2 float-left data-ordering" data-order="" data-order-by="createdBy.name">Created By</div>
            <div class="col-1 float-left data-ordering" data-order="" data-order-by="status">Status</div>
        ...
        <div class="w-100" id="data">
          @include('admin.team.data', ['teamMembers' => $teamMembers])
        </div>
      </div>
    </div>
  </div>
</div>
@include('admin.includes.admin_delete_model', ['title' => 'Team Member'])
@endsection