...
@include('admin.includes.content_header', ['title' => 'Category', 'route' => 'admin.categories.create', 'search' => true, 'search_route' => 'admin.categories.search'])
      ...
      <div class="card">
          <div class="w-100 card-header">
            ...
            <div class="col-11 float-left data-list pl-0">
              ...
              <div class="col-2 float-left data-ordering" data-order="" data-order-by="type">Category For</div>
        ...
        <div class="w-100" id="data">
          @include('admin.categories.data', ['categories' => $categories])
        </div>
      </div>
    </div>
  </div>
</div>
@include('admin.includes.admin_delete_model', ['title' => 'Category'])
@endsection
