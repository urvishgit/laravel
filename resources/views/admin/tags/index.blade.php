...
@include('admin.includes.content_header', ['title' => 'Tag', 'route' => 'admin.tags.create', 'search' => true, 'search_route' => 'admin.tags.search'])
      ...
      <div class="card">
        <div class="w-100 card-header">
          ...
          <div class="col-11 float-left data-list pl-0">
            ...
            <div class="col-3 float-left data-ordering" data-order="" data-order-by="createdBy.name">Created By</div>
            <div class="col-3 float-left data-ordering" data-order="" data-order-by="status">Status</div>
        ...
        <div class="w-100" id="data">
          @include('admin.tags.data', ['tags' => $tags])
        </div>
      </div>
    </div>
  </div>
</div>
@include('admin.includes.admin_delete_model', ['title' => 'Tag'])
@endsection
